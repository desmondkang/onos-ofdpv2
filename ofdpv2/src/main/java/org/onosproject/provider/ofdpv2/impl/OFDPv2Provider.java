...
import org.onosproject.provider.ofdpv2.lldpcommon_ofdpv2.LinkDiscovery;
import org.onosproject.provider.ofdpv2.lldpcommon_ofdpv2.LinkDiscoveryContext;
...
import static org.onosproject.provider.ofdpv2.impl.OsgiPropertyConstants.*;
import static org.slf4j.LoggerFactory.getLogger;

/**
 * Skeletal ONOS LLDP Topology Discovery using OFDPv2 Component
 */
@Component
        (
                immediate = true,
                service = OFDPv2Provider.class,
                property =
                        {
...
public class OFDPv2Provider extends AbstractProvider implements ProbedLinkProvider
{
    private static final String PROVIDER_NAME = "org.onosproject.provider.ofdpv2";
    ...
    private SuppressionRules rules = OFDPv2Provider.DEFAULT_RULES;
