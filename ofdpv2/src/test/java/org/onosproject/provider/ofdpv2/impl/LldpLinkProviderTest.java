...
import static org.onosproject.provider.ofdpv2.impl.OFDPv2Provider.DEFAULT_RULES;
...
public class LldpLinkProviderTest {
    ...
    private final OFDPv2Provider provider = new OFDPv2Provider();
    ...
    public void switchSuppressedByAnnotation() {
        ...
        deviceService.putDevice(device(DID3, DefaultAnnotations.builder()
                .set(OFDPv2Provider.NO_LLDP, "true")
                .build()));
